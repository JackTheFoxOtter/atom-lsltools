...
export default {
	...
	activate(state) {
		...
		myself.console.print("Event", "Subscription => onActiveTextEditorChanged", debugEvents);
	...
	test() {
		// myself.console.print("Debug", "Debug button pressed!...");
		// myself.console.print("Debug", "Testing overlay processing...");
		// myself.contextDocumentation.process();
		let progressNotification = new LsltoolsProgressNotification("Loading something...");
		progressNotification.setProgress(0.25);
		progressNotification.setText("Test!");
	},
	...
	onActiveTextEditorChanged(editor) {
		...
		myself.console.print("Event", "Active editor changed", debugEvents);
		...
		if (editor !== undefined) {
			...
			myself.console.print("Event", "Subscription => onCursorPositionChanged", debugEvents);
		}
	...
	onCursorPositionChanged(event) {
		...
		myself.console.print("Event", `Cursor position changed: Old ${event.oldBufferPosition}, New ${event.newBufferPosition}, Text Changed '${event.textChanged}'`, debugEvents);
