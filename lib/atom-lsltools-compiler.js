	...
	compile(sourcePath) {
		...
		myself.main.preprocessor.preprocess(scriptPaths, () => {
            ...
            child.stderr.on('data', (data) => {
                ...
                if (matches) {
                    // Exact position of error specified
                    // TODO: This shows line-number of final, preprocessed file, but NOT that of the actual source file.
                    //       Pre-Processors need to keep track of how they modify
                    myself.main.console.print("LSL Compiler",
                        matches[0],
                        () => { myself.main.console.print(`Line ${matches[1]}, Column ${matches[2]}`); },
